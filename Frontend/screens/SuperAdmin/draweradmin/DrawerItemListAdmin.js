...
const DrawerItemAdmin = ({ label, onPress, tabBarTestID, type, name, notification,
...
const DrawerItemListAdmin = ({ state, descriptors, navigation, styles }) => {
  return (
    <View style={styles.view}>
      {state.routes.map((route, index) => {
        ...
        return (
          <DrawerItemAdmin key={index} label={drawerItem.label}
...
export default DrawerItemListAdmin
