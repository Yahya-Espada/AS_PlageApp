...
import DrawerItemListAdmin from './DrawerItemListAdmin'
...
const CustomDrawerAdmin = (props) => {
  ...
  const getData = async () => {
    try {
      const usernom = await AsyncStorage.getItem('usernom')
      const userprenom = await AsyncStorage.getItem('userprenom')
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.ScrollView
        ...
        <DrawerItemListAdmin {...props} styles={styles} />
        <Animated.View
        ...
        <Animated.View
          ...
          <Image style={styles.profile} source={require(lienimage + 'salah.jpg')} />
