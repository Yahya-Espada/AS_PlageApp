        ...
        <View style={styles.container}>
            ...
            >
                <ScrollView style={{ margin: 10 }}>
                    ...
                    <View style={styles.action}>
                        <TextInput
                            placeholder="اضافة رتبة"
                            placeholderTextColor="#666666"
                            style={[styles.textInput, {
                                color: colors.text
                            }]}
                            autoCapitalize="none"
                            onChangeText={(val) => PrivilegeChange(val)}
                            onEndEditing={(e) => handleValidPrivilege(e.nativeEvent.text)}
                        />
                        {data.Change_privilege_municipalite ?
                            <Animatable.View
                                animation="bounceIn"
                            >
                                <Feather
                    ...
                    {data.isValidPrivilege ? null :
                        <Animatable.View animation="fadeInLeft" duration={500}>
                            <Text style={styles.errorMsg}>لا توجد رتبة</Text>
                        </Animatable.View>
                    }
                    <Text style={[styles.text_footer, {
                        color: colors.text
