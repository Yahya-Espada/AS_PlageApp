...
import ListOfPlages from '../../AgentMunicipalite/ListesOfPages/ListOfPlages';
import ListOfOffres from '../../AgentMunicipalite/ListesOfPages/ListOfOffres';
import { municipalite } from '../../../infomationsmunicipalite';
const { width, height } = Dimensions.get("window")
const TabArr = [
    { route: 'ListOfPlages', label: 'إدارة الشواطئ', type: Icons.MaterialCommunityIcons, icon: 'beach', component: ListOfPlages },
    { route: 'ListOfParkings', label: 'إدارة مآوي السيارات', type: Icons.MaterialCommunityIcons, icon: 'car-cog', component: DrawerScreen },
    { route: 'ListOfOffres', label: 'إدارة طلبات العروض', type: Icons.FontAwesome5, icon: 'file-contract', component:ListOfOffres},
