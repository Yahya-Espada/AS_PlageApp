...
export default function ListOfOffres({ navigation }) {
    ...
    const gotonewagent = () => {
         navigation.navigate('AddNewOffre')
    }
    const onRefresh = () => {
    ...
    const ContactItem = ({ item: { id_offre, nom_offre }, index, animation }) => {
        ...
        return (
            ...
            >
                ...
                <TouchableOpacity style={styles.item}
                    onPress={() => handlePress(id_municipalite)}
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => gotonewagent()}
                    >
                        <Text style={{ marginRight: 10, color: Colors.primary, fontSize: 20 }}>إضافة طلبات عروض</Text>
